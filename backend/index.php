...
include './src/api/Product.php';
include './src/api/Audit.php';
...
include './src/ProductsPurchasedInterface.php';
                ...
                foreach ($dayData as $order) {
                    ...
                    foreach ($order as $item => $quantitiesOrdered) {
                        ...
                        if ($index >= 0) {
                            ...
                            $poDays = $this->products[$index]->poRemainingDeliveryDays;
                            ...
                            if ($poDays > 0) {
                                $this->products[$index]->poRemainingDeliveryDays = ($poDays - 1);
                            } else if ($poDays === 0) {
                                ...
                                $this->products[$index]->poRemainingDeliveryDays = (-1);
                            ...
                            if ($newStock < 10 && $poDays == -1) {
                                //Create PO
                                $this->products[$index]->poRemainingDeliveryDays = (2);
                                $this->products[$index]->purchasedAndPending = ($this->products[$index]->purchasedAndPending + 20);
...
function simulateSevenDays()
{
    ...
    var_dump(json_encode($orderProcessor->products,JSON_PRETTY_PRINT));
}
